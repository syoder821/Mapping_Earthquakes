...
// 2. Add a reference to the tectonic plates group and major earthquake grop to the overlays object.
let overlays = {
...
// Looping through our intervals to generate a label with a colored square for each interval.
 ...
 d3.json("https://github.com/fraxen/tectonicplates/blob/master/GeoJSON/PB2002_boundaries.json").then(function(data) {
  // Direct access to file intially used to combat CORS error
